...
const QNA = () => {
  const qAndAData = [
    ...
    },
    {
      ...
      answer:
      <p className="qna-answer">
        שאלה מצוינת. המשותף למרבית הדו"חות זה ההסברים - וותק, שעות נוספות, הוצאות רווחה ועוד - לא פערים על רקע מגדרי. חסרה לקיחת אחריות, וצעדים מצד החברות לצמצום הפער, כמו גם אחידות ושקיפות לגבי המידע שחברות מחוייבות להציג לגבי המידע שחברות מחוייבות להציג. כדי שהחוק הזה יתורגם למעשים בפועל, יש לנקוט צעדים ממשיים -
