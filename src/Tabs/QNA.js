...
const QNA = () => {
  ...
  },
  {
    ...
    <div>
      <p className="qna-answer">
        1. בגדול, למינוסים. יש פערי שכר. והם לא קטנים בכלל.
      </p>
      <p className="qna-answer">
  ...
  },
  {
    ...
    <div>
      ...
      <p className="qna-answer">
        עוד חשוב לשים לב, כי באותה כתבה מצויין כי "החוק יחול על 180 מעסיקים גדולים, בפיילוט לשלוש שנים, שבסיומו יוחלט אם להרחיבו" - ואנחנו רוצים שירחיבו. כך כתוב, כי אם ישנו את מספר הקסם 518 ל-100, נזכה לשקיפות בפערי השכר בקרוב ל-3000 חברות.
      </p>
    </div>
  },
  {
    ...
    answer:
    <p className="qna-answer">
      שאלה מצוינת. חסרה אחידות ושקיפות לגבי המידע שחברות מחוייבות להציג. כדי שהחוק הזה יתורגם למעשים בפועל, יש לנקוט צעדים ממשיים -
       <a href='https://www.calcalist.co.il/local_news/article/sjjn2ri00c'
      className='link' target='_blank'> חוק גילוי פערי השכר לא ישפיע ללא סנקציות.</a>
    </p>
  }
];
