...
const QNA = () => {
  const qAndAData = [
    ...
    },
    {
      ...
      <div>
        <p className="qna-answer">
          כל חברה מחוייבת לפרסם נתונים על פערי השכר בין נשים לגברים, איך אין אחידות או הנחייה לגבי הדרך בה יעשה הפילוח, וכל חברה בונה את הדוח לראות עיניה, והמידע נראה עמוס ולא מסודר. בגדול, אלו הדברים שכדאי לראות:
        </p>
        <ol className="qna-answer">
          ...
          <li>
            פילוחים בדוחות שנותרו ריקים מטעמי פרטיות של העובדים באותה קבוצת פילוח. למעשה המשמעות של זה היא לרוב קבוצה שמכילה רק נשים או רק גברים. אמנם זה לא מראה מספר שמצביע על פער, אבל מציף בעיה אחרת חשובה לא פחות.
          </li>
          <li>
