...
const QNA = () => {
  const qAndAData = [
    ...
    },
    {
      ...
      <div>
        <p className="qna-answer">
          אמנם חברות מפרסמות נתונים על פערי השכר, אך אין אחידות או הנחייה לגבי הדרך בה יעשה הפילוח, כל חברה בונה את הדוח לראות עיניה, והמידע נראה עמוס ולא מסודר. חסרה שקיפות ואחידות בנוגע למידע שחברות צריכות להציג.
        </p>
        <p className="qna-answer">
          מעבר לכך, חסרים נתונים רבים - אחוז הנשים בעמדות ניהוליות בחברה, קצב התקדמות לעומת גברים, פערים בבונוסים, מענקי חתימה ועוד.
        </p>
      </div>
    },
    {
      ...
      <div>
        <p className="qna-answer">
          המשותף למרבית הדו"חות זה ההסברים - וותק, שעות נוספות, הוצאות רווחה, מענקי פרישה ועוד - לא פערים על רקע מגדרי. אין מעקב אחרי תוצאות הדוחות משנה לשנה לבדוק שלכל הפחות אין עלייה בפער, שלא לדבר על צמצומו. חסרה לקיחת אחריות, הסקת מסקנות וצעדים לצמצום הפער. כדי שהחוק הזה יתורגם למעשים בפועל, יש לנקוט צעדים ממשיים -
