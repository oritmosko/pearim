...
const A3 = () => {
  return (
    <div className="answer">
      <p>
        <b>בפועל</b>, אמנם חברות מפרסמות נתונים על פערי השכר, אך אין אחידות או הנחייה לגבי הדרך בה יעשה הפילוח, כל חברה בונה את הדוח לראות עיניה, והמידע עמוס ולא מסודר, וקשה מאוד לניתוח ועיבוד.
